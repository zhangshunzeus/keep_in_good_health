...
public class QRCodeReaderView extends SurfaceView implements SurfaceHolder.Callback,Camera.PreviewCallback {
	...
	@TargetApi(Build.VERSION_CODES.ECLAIR) @SuppressLint("NewApi") private boolean checkCameraHardware(Context context) {
     ...
     */
    @TargetApi(Build.VERSION_CODES.FROYO) @SuppressLint("NewApi") @SuppressWarnings("deprecation")

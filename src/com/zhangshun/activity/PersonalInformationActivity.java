...
public class PersonalInformationActivity extends Activity {
	...
	OnClickListener click = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.dialog_head_portrait: //头像
				...
				intent_uploadToServer.setClass(PersonalInformationActivity.this, UploadToServerActivity.class);
	...
	private void dialog_username_text(){
	         ...
	         LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
	          final View textEntryView = factory.inflate(R.layout.dialog_username_text, null);
	           AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
	             .setTitle("请输入昵称")
	               .setView(textEntryView)
	                 .setPositiveButton("OK", new DialogInterface.OnClickListener() {
	                   public void onClick(DialogInterface dialog, int whichButton) {
	                    EditText secondPwd = (EditText) textEntryView.findViewById(R.id.edit_dialog_username_text);
	...
	private void dialog_log_in_the_phone(){
	      ...
	      LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
          final View textEntryView = factory.inflate(R.layout.dialog_log_in_the_phone, null);
           AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
             .setTitle("请输入手机号")
               .setView(textEntryView)
                 .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int whichButton) {
                    EditText secondPwd = (EditText) textEntryView.findViewById(R.id.edit_dialog_log_in_the_phone);
                     String inputPwd = secondPwd.getText().toString();
                      setTitle(inputPwd);
	...
	private void dialog_the_login_password(){
		...
		LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
        final View textEntryView = factory.inflate(R.layout.dialog_the_login_password, null);
         AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
           .setTitle("请输入手机号")
             .setView(textEntryView)
               .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                 public void onClick(DialogInterface dialog, int whichButton) {
                  EditText secondPwd = (EditText) textEntryView.findViewById(R.id.edit_dialog_the_login_password);
                   String inputPwd = secondPwd.getText().toString();
                    setTitle(inputPwd);
	...
	private void dialog_binding_wechat_id(){
		...
		LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
        final View textEntryView = factory.inflate(R.layout.dialog_binding_wechat_id, null);
         AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
           .setTitle("请输入手机号")
             .setView(textEntryView)
               .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                 public void onClick(DialogInterface dialog, int whichButton) {
                  EditText secondPwd = (EditText) textEntryView.findViewById(R.id.edit_dialog_binding_wechat_id);
                   String inputPwd = secondPwd.getText().toString();
                    setTitle(inputPwd);
	...
	private void dialog_the_binding_of_sina_weibo(){
		...
		LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
        final View textEntryView = factory.inflate(R.layout.dialog_the_binding_of_sina_weibo, null);
         AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
           .setTitle("请输入手机号")
             .setView(textEntryView)
               .setPositiveButton("OK", new DialogInterface.OnClickListener() {
	...
	private void dialog_binding_alipay(){
		...
		LayoutInflater factory = LayoutInflater.from(PersonalInformationActivity.this);
        final View textEntryView = factory.inflate(R.layout.dialog_binding_alipay, null);
         AlertDialog dlg = new AlertDialog.Builder(PersonalInformationActivity.this)
           .setTitle("请输入手机号")
             .setView(textEntryView)
               .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                 public void onClick(DialogInterface dialog, int whichButton) {
                  EditText secondPwd = (EditText) textEntryView.findViewById(R.id.edit_dialog_binding_alipay);
                   String inputPwd = secondPwd.getText().toString();
                    setTitle(inputPwd);

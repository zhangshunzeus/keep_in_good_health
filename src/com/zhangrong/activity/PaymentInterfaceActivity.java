    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        payment_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(PaymentInterfaceActivity.this,TheShopingCartActivityGG.class);
...
BP.pay(PaymentInterfaceActivity.this,"购买商品是"+shopName, shopName, sun, false, new PListener() {
			...
			@Override
			public void succeed() {
				 Toast.makeText(PaymentInterfaceActivity.this, "支付成功,返回到购物车", Toast.LENGTH_SHORT)
                 .show();
				 finish();
			...
			public void orderId(String arg0) {
				 Toast.makeText(PaymentInterfaceActivity.this, "支付订单id："+arg0, Toast.LENGTH_SHORT)
                 .show();
			...
			public void fail(int arg0, String arg1) {
				Toast.makeText(PaymentInterfaceActivity.this, "支付失败了，请从新支付", Toast.LENGTH_SHORT)
                .show();
	...
	private void payAilPAY() {
		BP.pay(PaymentInterfaceActivity.this, "购买商品是"+shopName, shopName, sun, true, new PListener() {

 ...
 * @编者   zhangrong
 */
public class MealnameInfo {
    public int meal_name_show_image;
    public int food_iamge_one;
    public int food_iamge_two;
    public String food_text_one_title;
    public String food_text_two_title;
    public String food_text_one_text;
    public String food_text_two_text;
    ...
    public String getFood_text_one_title() {
        return food_text_one_title;
    }

    public void setFood_text_one_title(String food_text_one_title) {
        this.food_text_one_title = food_text_one_title;
    }

    public String getFood_text_two_title() {
        return food_text_two_title;
    }

    public void setFood_text_two_title(String food_text_two_title) {
        this.food_text_two_title = food_text_two_title;
    }

    public String getFood_text_one_text() {
        return food_text_one_text;
    }

    public void setFood_text_one_text(String food_text_one_text) {
        this.food_text_one_text = food_text_one_text;
    }

    public String getFood_text_two_text() {
        return food_text_two_text;
    }

    public void setFood_text_two_text(String food_text_two_text) {
        this.food_text_two_text = food_text_two_text;
    }

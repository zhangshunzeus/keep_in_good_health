...
public class MealnameInfo {
    ...
    public MealnameInfo(int meal_name_show_image, int food_iamge_one, String food_text_one, int food_iamge_two, String food_text_two, int food_iamge_three, String food_text_three, String meal_name_Liao_text, String meal_name_dosing_text, String meal_name_practice_text) {
